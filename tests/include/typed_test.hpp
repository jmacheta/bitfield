...
using BitfieldTypes =
    ::testing::Types<std::uint8_t, std::uint16_t, std::uint32_t, std::uint64_t, unsigned char,
                     unsigned short, unsigned, unsigned long, unsigned long long,

                     std::int8_t, std::int16_t, std::int32_t, std::int64_t, signed char, short, int,
                     long, long long>;

using BitfieldArithmeticTypes =
    ::testing::Types<std::uint8_t, std::uint16_t, std::uint32_t, std::uint64_t, unsigned char,
                     unsigned short, unsigned, unsigned long, unsigned long long,
