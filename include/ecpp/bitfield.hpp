...
namespace ecpp {
    ...
    namespace bf_impl {
        ...
        template<class T> inline constexpr bool has_signed_representation_v = has_signed_representation<T>::value;
    ...
    class bitfield_view {
      ...
      public:
        ...
        constexpr static bitmask<std::remove_cv_t<storage_type>> mask{static_cast<storage_type>(Spec::mask)};
        ...
        [[nodiscard]] constexpr value_type value() const noexcept {
            ...
            if constexpr (!has_signed_representation_v<value_type>) {
                return static_cast<value_type>(static_cast<storage_type>(data >> mask.trailing_zeros()) & mask.base_value());
            }
            auto v_shifted = static_cast<std::make_signed_t<storage_type>>(static_cast<storage_type>(data << mask.leading_zeros()));
            ...
            requires(!std::is_const_v<storage_type>)
        {
            ...
            auto masked_value = static_cast<storage_type>(static_cast<storage_type>(static_cast<storage_type>(v) << mask.trailing_zeros()) & mask.value());
            data              = static_cast<storage_type>(masked_value | static_cast<storage_type>(current & (~mask).value()));
            return *this;
        }
